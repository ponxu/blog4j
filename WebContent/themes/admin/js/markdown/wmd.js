...
var convertHTMLWhenSubmit = true;
...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>Enter the image URL.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>Example:<br />http://wmd-editor.com/images/cloud1.jpg   \"Optional title\"</p><p><input type='button' value='上传' onclick='upload()'></p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>Enter the web address.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>Example:<br />http://wmd-editor.com/   \"Optional title\"</p><p><input type='button' value='上传' onclick='upload()'></p>";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var setupEditor = function(){
			...
			if (inputBox.form && convertHTMLWhenSubmit) {
	...
	command.doLinkOrImage = function(chunk, postProcessing, isImage){
		...
		if (chunk.endTag.length > 1) {
			...
			var makeImageMarkdown = function(link){
				if (link !== null) {
					chunk.startTag = "![";
					chunk.endTag = "](" + link + ")";
					
					if (!chunk.selection) {
						chunk.selection = "image alt text";
					}
				}
				postProcessing();
			};
			...
			if (isImage) {
				util.prompt(imageDialogText, imageDefaultText, makeImageMarkdown);
			}
			else {
